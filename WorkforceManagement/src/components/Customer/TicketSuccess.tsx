    ...
    <div>
      <div className="p-4 max-w-lg mx-auto h-full md:h-auto">
        <div className="relative p-6 text-center bg-gray-50 rounded-lg shadow-lg">
          ...
          <div>
            <a href="#" className="text-blue-600 hover:text-blue-800 underline font-medium transition-colors duration-200 ease-in-out">You can check the status of your ticket here.</a>
          </div>
          <div className="pt-4">
            <button
              type="button"
